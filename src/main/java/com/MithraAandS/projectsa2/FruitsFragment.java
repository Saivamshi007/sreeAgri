...
public class FruitsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        blog_list_view = view.findViewById(R.id.fruits_list);
        ...
        if (firebaseAuth.getCurrentUser() != null) {
          ...
          /*  blog_list_view.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            Query firstQuery = firebaseFirestore.collection("Posts").document("Fruits").collection("Product").orderBy("timestamp", Query.Direction.DESCENDING);
                    ...
                    try {
                        ...
                        for (DocumentChange doc : documentSnapshots.getDocumentChanges()) {
                            ...
                            if (doc.getType() == DocumentChange.Type.ADDED) {
                                ...
                                BlogPost frag = doc.getDocument().toObject(BlogPost.class).withkey("Fruits");
                                if (isFirstPageFirstLoad) {
...
//        blogRecyclerAdapter.notify();
    ...
    public void loadMorePost(){
        ...
        if (firebaseAuth.getCurrentUser()!=null) {
            ...
            Query nextQuery = firebaseFirestore.collection("Posts").document("Fruits").collection("Product").orderBy("timestamp", Query.Direction.DESCENDING).startAfter(lastVisible).limit(5);
